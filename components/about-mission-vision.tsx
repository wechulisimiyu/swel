        ...
        <div className="flex gap-6 h-125">
          ...
          <div className="flex-1 bg-swel-navy-mid rounded-xl p-12 flex flex-col justify-end relative overflow-hidden">
            <div className="flex flex-col gap-2 pb-2">
              <span className="text-[12px] font-semibold leading-3 tracking-[0.6px] uppercase text-swel-accent2">
                MISSION
              </span>
            </div>
            <h2 className="text-[32px] font-bold leading-10.5 tracking-[-0.32px] text-white">
            ...
            <div className="absolute right-0 top-0 w-34.75 h-41 p-8 opacity-10">
              <div className="w-18.75 h-25 bg-[#191C1E] rounded-sm" />
            </div>
          </div>
          ...
          <div className="flex-1 bg-swel-navy rounded-xl p-12 flex flex-col justify-end">
            <div className="flex flex-col gap-2 pb-2">
              <span className="text-[12px] font-semibold leading-3 tracking-[0.6px] uppercase text-swel-accent">
                VISION
              </span>
            </div>
            <h2 className="text-[32px] font-bold leading-10.5 tracking-[-0.32px] text-white">
